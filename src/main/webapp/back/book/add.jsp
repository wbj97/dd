		...
		<form action="${path }/book/insert"  method="post" enctype="multipart/form-data">
			<table>
				<tr>
					...
					<td>页数：</td>
					<td><input type="number" name="pagination" class="el-input__inner"></td>
				</tr>
				<tr>
					<td>所属分类：</td>
					<td>
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="recom"></textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					...
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="brief"></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					...
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="aboutAuthor"></textarea></td>
				</tr>
				<tr>
					<td>印次：</td>
				...
				<tr>
					...
					<td>基本目录：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="directory"></textarea></td>
				</tr>
				<tr>
					<td>开本：</td>
					<td><input type="text" name="format" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>纸张：</td>
					...
					<td>媒体评论：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="media"></textarea></td>
				</tr>
				<tr>
					<td>包装：</td>
					<td><input type="text" name="packaging" class="el-input__inner"></td>
					<td></td>
				</tr>
			</table>
